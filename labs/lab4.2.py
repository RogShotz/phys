...
lamb = 5  # LINEAR mass density ofa rod
c = 5.55  # constant for LINEAR mass density = c * x**k
k = 2  # exponent for LINEAR mass density = c * x**k
L = 5.0  # length of rod
N = 13  # number of slices for rod, must be >1
...
Perc_Error = (COM.x - 2*L/3)/(2*L/3)*100
