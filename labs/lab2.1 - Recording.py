...
#draw the ground
#ground = box(pos = vector(0, -incline.length*.5*sin(theta), 0),
#              length = 20,
#              width = 2,
#              height = 0.2,
...
pulley = cylinder(axis = vector(0,0,1),
                  radius = 0.5*block1.width,
                  color = color.blue)
